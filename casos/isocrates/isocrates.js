    ...
    try {
      if (location.protocol === "file:") {
        ...
        content.innerHTML = `
          <p style="text-align:center; opacity:.85; line-height:1.6;">
            Estás en <strong>file://</strong>.<br>
            Abre con <strong>Live Server</strong> o publícalo en Netlify/GitHub Pages para que funcionen las tabs.
          </p>
        `;
        return;
      }
      ...
      content.innerHTML = `
        <p style="text-align:center; opacity:.85; line-height:1.6;">
          ...
          Revisa el nombre del archivo y la carpeta.
        </p>
      `;
    }
  }
